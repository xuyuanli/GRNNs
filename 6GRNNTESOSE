...
subroutine GSS(ax,bx,cx,in,out,ro,co,minf,minx)      !low, mid, up guessing, input data, size, minTatget, minValue
implicit none
...
subroutine BW_TESSE(fc1,inx,outy,nr,nc)
implicit none
...
!Estimate bandwidths (GRR)
   ...
   do c3=1,10
      ...
      a3=a1+c3*a4/10
      a2=(a1+a3)/2.0
      call GSS(a1,a2,a3,inx,outy,nr,nc,t1(c3),h1(c3)) 
    end do   
